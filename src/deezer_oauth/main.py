...
def main(app_id: str, app_secret: str) -> None:
    """
    Get an API token from Deezer.

    This script spins up a basic HTTP server, performs the OAuth flow to generate
    ...
    This will give you an application ID a secret key to pass as arguments.
    """
    # Begin OAuth flow
